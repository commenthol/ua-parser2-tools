...
ReportType.prototype._selectFields = function () {
	...
	switch (this.type) {
		...
		case 'engine':
		case 'os':
			fields = [ 'debug', 'family', 'version', 'type', 'string' ];
			if (this.swap) {
				fields = [ 'family', 'version', 'type', 'debug', 'string' ];
			}
			break;
		case 'device':
			fields = [ 'debug', 'brand', 'model', 'family', 'type', 'string' ];
			if (this.swap) {
				fields = [ 'brand', 'model', 'family', 'type', 'debug', 'string' ];
			}
			break;
		default:
			fields = [
				'ua.debug', 'ua.family', 'ua.version', 'ua.type',
				'engine.debug', 'engine.family', 'engine.version', 'engine.type',
				'os.debug', 'os.family', 'os.version', 'os.type',
				'device.debug', 'device.brand', 'device.family', 'device.model', 'device.type',
				'string' ];
			break;
	}
	return fields;
...
ReportFailed.prototype._selectFields = function () {
	...
	switch (this.type) {
		...
		case 'engine':
		case 'os':
			fields = [ 'debug', 'is.family', 'was.family', 'is.version', 'was.version', 'is.type', 'was.type', 'string' ];
			if (this.swap) {
				fields = [ 'is.family', 'was.family', 'is.version', 'was.version', 'is.type', 'was.type', 'debug', 'string' ];
			}
			break;
		case 'device':
			fields = [ 'debug', 'is.brand', 'was.brand', 'is.model', 'was.model', 'is.type', 'was.type', 'string' ];
			if (this.swap) {
				fields = [ 'is.brand', 'was.brand', 'is.model', 'was.model', 'is.type', 'was.type', 'debug', 'string' ];
			}
			break;
		default:
			fields = [
				'ua.debug', 'ua.is.family', 'ua.was.family', 'ua.is.version', 'ua.was.version', 'ua.is.type', 'ua.was.type',
				'engine.debug', 'engine.is.family', 'engine.was.family', 'engine.is.version', 'engine.was.version', 'engine.is.type', 'engine.was.type',
				'os.debug', 'os.is.family', 'os.was.family', 'os.is.version', 'os.was.version', 'os.is.type', 'os.was.type',
				'device.debug', 'device.is.brand', 'device.was.brand', 'device.is.model', 'device.was.model', 'device.is.type', 'device.was.type',
				'string' ];
			break;
	}
	return fields;
